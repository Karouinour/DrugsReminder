...
import com.sim.drugsreminder.sqllite.AlarmContract.Alarm;
...
public class AlarmDBHelper extends SQLiteOpenHelper {
	...
	private static final String SQL_CREATE_ALARM = "CREATE TABLE " + Alarm.TABLE_NAME + " (" +
			...
			Alarm.COLUMN_NAME_ID_Drug + " INTEGER," +
	...
	private AlarmModel populateModel(Cursor c) {
		...
		model.id_drug = c.getInt(c.getColumnIndex(Alarm.COLUMN_NAME_ID_Drug));
	...
	private ContentValues populateContent(AlarmModel model) {
		...
		values.put(Alarm.COLUMN_NAME_ID_Drug, model.id_drug);
	...
	public List<AlarmModel> getAlarmsByDrugID(int iddrug) {
		SQLiteDatabase db = this.getReadableDatabase();
		
        String select = "SELECT * FROM " + Alarm.TABLE_NAME + " WHERE " + Alarm.COLUMN_NAME_ID_Drug + " = " + iddrug;
